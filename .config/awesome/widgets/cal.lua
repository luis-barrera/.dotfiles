...
local function factory(args)
  ...
  local cal = {
    ...
    week_start          = 2, -- Semana empieza en lunes
    three               = true, -- Muestra mes pasado y siguiente
    followtag           = true, -- Muestra el calendario en la pantalla enfocada
    week_number         = "none",
    week_number_format  = args.week_number_format or args.week_number == "left" and "%3d | " or "| %-3d",
    icons               = HOME .. "/.config/awesome/widgets/images/cal/",
